...
// "quelque chose a changé, code de salle tel, va relire").
//
...
// S'abonne au canal de cette salle — `onUpdate` est appelé (sans argument utile, voir
// app.js qui relit l'état complet lui-même) dès qu'un événement 'update' arrive. Sans
