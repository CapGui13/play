...
assert(/const\s+LOCAL_DDS_MAX_DESKTOP_WORKERS\s*=\s*3\s*;/.test(app), 'R133: plafond desktop DDS local modifié');
...
assert(r133DesiredWorkers.includes('return LOCAL_DDS_MAX_DESKTOP_WORKERS'), 'R133: montée à 3 Workers desktop absente');
